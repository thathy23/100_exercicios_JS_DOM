...
let resultadoSoma = calculaSoma();
console.log (`A soma dos valores do array é: ${resultadoSoma}`);
console.log ("Muito feliz em ter lembrado da estrutura do reduce sem olhar!! :)")